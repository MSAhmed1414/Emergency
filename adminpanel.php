...
<div class="Medicines" style="border: 1px black solid;margin-top: 20px;height: 200px;">
  <h2 style="text-align: center;">Include New  Medicine</h2>
  ...
  display: block;"><a href="addmedicines.php" style="color: white;">Include New Medicines Info</button>
</div>
...
<div class="Medicines" style="border: 1px black solid;margin-top: 20px;height: 200px;">
 <h3 style="text-align: center;color: black;">Transactions</h3>
  ...
  display: block;"><a href="purchase2.php" style="color: white;">Show Transactions All</button>
</div>

...
">
  ...
  <form action="" method="POST">
    <h3>Enter your Pharmacy Name</h3><br/>
    <input type="text" name="name" id="n" name="name" onkeyup="this.value=this.value.toUpperCase();"  required placeholder="Pharmacy name" >
    <br/>
    <br/>
    ...
    <select name="area" >
      ...
      <option value="Mohammadpur">Uttara</option>     
...
alert('false');
    ...
    $password=base64_encode($password);
     ...
     $sql="insert into pharmacy(name,contact,area,email,password,road_no) values('$name',$contact,'$area','$email','$password','$road_no');";

...
<div style="text-align: center;height: 200px; margin-top: 200px;">
 <form class="login" action="" method="POST">
    ...
    <h1><a href="login.php" style="color: black;">Pharmacy LoGin</a></h1>
...
" >Submit</button>
   ...
   <a class="h" href="pharmacysignup.php" style="background-color: #4682B4; /* Green */
  border: 1px solid green;
  color: white;
  padding: 15px 32px;
  text-align: center;
...
<?php
    if(isset($_POST['submit1'])){
      include 'connector.php';
       ...
       $sql="select password from pharmacy where email='$username';";
        ...
        $count++;
         ...
         if($pass==$passw){
          $SESSION['username']=$username;
                $url="pharmacypanel.php?username=$username";
